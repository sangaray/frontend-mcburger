...
export default function MapView({ branches }) {
    ...
    const getMarkers = () => {
        ...
        markers.push(
            <Marker position={[location.coordinates.lat,location.coordinates.lng]} icon={iconUser}>
                <Popup>
                    You are here! <br /> 
                </Popup>
            </Marker>
    ...
    return (
        <div>
            <MapContainer minZoom={6} center={newPosition.coordenates} zoom={ZOOM_LEVEL} scrollWheelZoom={true} className="leaflet-map-container">
                <TileLayer
