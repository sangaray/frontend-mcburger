    ...
    return(
        <Box h="400px" w="auto" backgroundColor="black">
            ...
            <Box w="33.3%" flexDirection="column" ml="70px" mt="0px" >
                <Text fontWeight="bold" fontSize="20px" color="white" mb="30px">Enlaces</Text>
            ...
            <Box w="33.3%" textAlign="center">
                <Text fontWeight="bold" fontSize="20px" color="white" mb="10px">Contáctanos</Text>
                <Input backgroundColor="white" mb="10px" placeholder='Nombre'/>
                <Input backgroundColor="white" mb="10px" placeholder='E-Mail'/>
                <Textarea backgroundColor="white" placeholder="Escribe aqui tu comentario... " />
            </Box>
            <Box w="33.3%"  textAlign="center">
                <Text color="white" fontWeight="bold" fontSize="20px">Redes sociales</Text>
                <Box mt="60px">
