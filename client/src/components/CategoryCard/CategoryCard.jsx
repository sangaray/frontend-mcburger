...
export default function CategoryCards() {
    ...
    function handleFilterCategory(c) {
        console.log("llegue al handle event")
        ...
        <div>
            <div className='cards-container'>
                ...
                <div className="card-container">
                    ...
                    <h3>Burger</h3>
                    <Link to="/Menu">
                        <button className="button" onClick={() => handleFilterCategory("Burger")} >Click Here</button>
                    </Link>
                </div>
                ...
                <div className="card-container">
                    ...
                    <Link to="/Menu">
                        <button className="button" onClick={() => handleFilterCategory("chicken burger")} > Click Here</button>
                    </Link>
                </div>
                ...
                <div className="card-container">
                    ...
                    <h3>Nuggets</h3>
                    <Link to="/Menu">
                        <button className="button" onClick={() => handleFilterCategory("nuggets")} > Click Here</button>
                    </Link>
                </div>
                ...
                <div className="card-container">
                    ...
                    <h3>Coffee</h3>
                    <Link to="/Menu">
                        <button className="button" onClick={() => handleFilterCategory("coffee")} > Click Here</button>
                    </Link>
                </div>
                ...
                <div className="card-container">
                    ...
                    <h3>Bakery</h3>
                    <Link to="/Menu">
                        <button className="button" onClick={() => handleFilterCategory("bakery")} > Click Here</button>
                    </Link>
                </div>
                ...
                <div className="card-container">
                    ...
                    <h3>Beverages</h3>
                    <Link to="/Menu">
                        <button className="button" onClick={() => handleFilterCategory("beverages")} > Click Here</button>
                    </Link>
                </div>
                ...
                <div className="card-container">
                    ...
                    <Link to="/Menu">
                        <button className="button" onClick={() => handleFilterCategory("desserts & Shakes")} > Click Here</button>
                    </Link>
                </div>
                ...
                <div className="card-container">
                    ...
                    <h3>Sides</h3>
                    <Link to="/Menu">
                        <button className="button" onClick={() => handleFilterCategory("sides")} > Click Here</button>
                    </Link>
                </div>
                ...
                <div className="card-container">
                    ...
                    <h3>Vegetable</h3>
                    <Link to="/Menu">
                        <button className="button" onClick={() => handleFilterCategory("vegetable")} > Click Here</button>
                    </Link>
                </div>
                ...
                <div className="card-container">
                    ...
                    <h3>Combos</h3>
                    <Link to="/Menu">
                        <button className="button" onClick={() => handleFilterCategory("offers")} > Click Here</button>
                    </Link>
                </div>
